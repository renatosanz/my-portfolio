    ...
    <div className='MyWork-cont height-Sections-homepage' ref={selfRef}>
      <div className='middle-cont-section'>
        ...
        <section id='cont-projects'>
          {
            myProjects?.map((project,i)=><WorkBox key={i} urlProject={project.url} bg={project.bgColor} title={project.title} fontColor={project.fontColor} urlrepo={project.repository} icon={project.icon}/>)
          }
        </section>
      </div>
    </div>
